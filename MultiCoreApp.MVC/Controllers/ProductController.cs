...
namespace MultiCoreApp.MVC.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var pro = await _productApiService.GetAllWithCategoryAsync();
            return View(pro);
        }
        ...
        public async Task<IActionResult> Details(Guid id)
        {
            ...
            var proDto = await _productApiService.GetByIdForDetailAsync(id);
            return View(proDto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(ProductWithCategoryDto proDto)
        {
